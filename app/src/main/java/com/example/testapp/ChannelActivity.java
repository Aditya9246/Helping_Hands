...
import com.example.testapp.databinding.ActivityChannelBinding;
                ...
                .subscribeFor(
                        ...
                        event -> {
                            if (event instanceof TypingStartEvent) {
                                User users = ((TypingStartEvent) event).getUser();
                                currentlyTyping.add(users.getName());
                            } else if (event instanceof TypingStopEvent) {
                                User users = ((TypingStopEvent) event).getUser();
                                currentlyTyping.remove(users.getName());
                            }
